import {
  startBalanceSheetData,
  completeBalanceSheetData,
} from "./balance-sheet.reducer";

export const fetchBalanceSheetData = (selectedCompanies, daterange) => (
  dispatch
) => {
  dispatch(startBalanceSheetData());
  const data = [
  ...
  dispatch(completeBalanceSheetData(selectedCompanies, data));
};
