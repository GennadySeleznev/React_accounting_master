...
export const CompanyDeleteDialog = (props: ICompanyDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="documentManagementApp.company.delete.question">
        <Translate contentKey="documentManagementApp.company.delete.question" interpolate={{ id: companyEntity.id }}>
